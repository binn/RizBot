...
namespace RizBot.Modules
{
    public class ChannelModule : InteractionModuleBase<SocketInteractionContext>
    {
        ...
        public async Task SetChannelAsync([Required] IGuildChannel channel)
        {
            ...
            if (channelExists)
            {
                await RespondAsync("This channel is already registered to receive new play announcements.");
                return;
            }
            ...
            await RespondAsync("Channel added.");
        }
        ...
        public async Task RemoveChannel([Required] IGuildChannel target)
        {
            ...
            if (channel == null)
            {
                await RespondAsync("This channel isn't registered to receive new play announcements.");
                return;
            }
